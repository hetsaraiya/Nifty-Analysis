...
app = FastAPI(
    title="NIFTY Options Greeks Analyzer - Yahoo Finance Edition",
    description="Comprehensive NIFTY options analysis with real-time Yahoo Finance data",
    version="3.0.0",
    docs_url="/docs",
    redoc_url="/redoc"
)
...
async def root(request: Request):
    ...
    try:
        ...
        spot_price = yahoo_api.get_nifty_price()
...
async def get_historical_volatility(days: int = 30):
    ...
    try:
        ...
        volatility = yahoo_api.calculate_historical_volatility(days)
...
async def generate_options_chain(request: OptionsChainRequest):
    ...
    try:
        ...
        return GreeksResponse(
            ...
            analytics=analysis,
            metadata=metadata,
            data_source="Yahoo Finance + Enhanced OI Analysis",
            timestamp=datetime.now().isoformat()
        )
...
async def get_api_info():
    ...
    try:
        ...
        api_info = {
            "title": "NIFTY Options Greeks Analyzer",
            "version": "3.0.0",
            "description": "Yahoo Finance powered NIFTY options analysis API",
            "data_source": {
